...
namespace Codice.CmdRunner
{
    public class PlatformIdentifier
    {
        ...
        static bool IsRunningUnderMono()
        {
        ...
        static bool bIsWindowsInitialized = false;
        static bool bIsWindows = false;

        static bool bIsMacInitialized = false;
        static bool bIsMac = false;
    }
}
